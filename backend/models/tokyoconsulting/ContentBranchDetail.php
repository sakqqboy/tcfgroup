...
class ContentBranchDetail extends \backend\models\tokyoconsulting\master\ContentBranchDetailMaster{
    /**
    * @inheritdoc
    */
    ...
    */
    ...
    public static function countContentBranchDetail($contentBranchId)
    {
        $contentBranchDetail = ContentBranchDetail::find()
            ->where(["contentBranchId" => $contentBranchId])
            ->all();
        return count($contentBranchDetail);
    }
}
