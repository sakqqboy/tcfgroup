...
<div class="row mt-3">
    <div class="col-lg-12 mt-4 border border-dark bd-position">
        ...
        <div class="mt-2">
            ...
            <span
                class="font-body"><?= isset($contentDetail -> createDateTime) ? ModelMaster::engDate($contentDetail -> createDateTime, 2) : '' ?></span>
        </div>
        <div class="mt-2">
            <span class="font-sub"> Update date : </span>
            <span
                class="font-body"><?= isset($contentDetail -> updateDateTime) ?  ModelMaster::engDate($contentDetail -> updateDateTime, 2) : '' ?></span>
        </div>
        <div class="mt-2"></div>
    </div>
</div>