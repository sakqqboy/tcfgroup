    ...
    <div class="row mt-3">
        <div class="col-lg-12 mt-4 border border-dark bd-position">
            ...
            <div class="padding">
                ...
                <div class="col-lg-12 font-body h4">
                    BRANCH ID<br>
                    <input type="text" name="branchid" class="font-input form-control col-lg-6" required>
                </div>
                <div class="col-lg-12 font-body h4">
                    ADDRESS<br>
                    <textarea class="font-input form-control" name="address" id="exampleFormControlTextarea1" rows="3" required></textarea>
                </div>
                <div class="col-lg-12 font-body h4">
                    PICTURE<br>
                ...
                <button type="submit" class="btn btn-success font-button" href="<?=Yii::$app->homeUrl.'member/default/create-member'?>">Submit</button>
                <div class="col-lg-12">
                    <br>
                </div>
            </div>
