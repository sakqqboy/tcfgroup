    ...
    <table class="table table-bordered table-hover text-center mt-3">
        ...
        <tbody>
            ...
            <tr id="memberId-<?= $x['memberId']?>">
                ...
                ?>
                <td class="col-1">
                    <input class="input-checkbox form-check-input" type="checkbox"
                        id="checkbox-<?=$mtype['memberTypeId']?>-<?=$x['memberId']?>"
                        onclick="javascript:saveMemberType(<?=$x['memberId']?>, <?=$mtype['memberTypeId']?>)"
                        <?=$has==1?'checked':''?>>
                </td>
                <?php
                        $i++;
