...
use Yii;
use \common\models\tokyoconsulting\master\ContentBranchDetailMaster;
...
class ContentBranchDetail extends \common\models\tokyoconsulting\master\ContentBranchDetailMaster{
    /**
    * @inheritdoc
    */
