...
<div class="col-12">
    ...
    if ($canEdit == 1 && $userInThisBranch == 1) { ?>
        <div class=" col-12 text-end mb-3">
            <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-branch-detail/' . ModelMaster::encodeParams(["contentBranchId" => $abo['contentBranchId']]) ?>" target="_blank">Edit(<?= $branchName ?>)</a>
        </div>
    <?php
    }
    ?>
    ...
    <div class="row">
        ...
        ?>
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    if ($canEdit == 1 && $userInThisBranch == 1) { ?>
                        <div class=" col-12 text-end mb-3">
                            <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-branch-detail/' . ModelMaster::encodeParams(["contentBranchId" => $has['contentBranchId']]) ?>" target="_blank">Edit(<?= $branchName ?>)</a>
                        </div>
                    <?php
                    }
                    ?>
        ...
        if ($canEdit == 1 && $userInThisBranch == 1) { ?>
            <div class=" col-12 text-end mb-3">
                <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-branch-detail/' . ModelMaster::encodeParams(["contentBranchId" => $ches['contentBranchId']]) ?>" target="_blank">Edit(<?= $branchName ?>)</a>
            </div>
        <?php
        }
        ?>
