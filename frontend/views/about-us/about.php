...
if ($admin == 1) { ?>
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $existenceContent['contentId']]) ?>" target="_blank">Edit</a>
    </div>
<?php
}
?>
...
if ($admin == 1) { ?>
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $strategyContent['contentId']]) ?>" target="_blank">Edit</a>
    </div>
<?php
}
?>
...
if ($admin == 1) { ?>
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $shouldContent['contentId']]) ?>" target="_blank">Edit</a>
    </div>
<?php
}
?>
...
if ($admin == 1) { ?>
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $group['contentId']]) ?>" target="_blank">Edit</a>
    </div>
<?php
}
?>
...
if ($admin == 1) { ?>
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $footerContent['contentId']]) ?>" target="_blank">Edit</a>
    </div>
<?php
}
?>
...
<div class="col-12 pr12 mt-50 form-text-footer">
    ...
    if ($admin == 1) { ?>
        <div class=" col-12 text-end edit-content">
            <a class="btn btn-warning bt-line" href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $ftContact['contentId']]) ?>" target="_blank">Edit</a>
        </div>
    <?php
    }
    ?>
