...
?>
    <div class="col-12" style="margin-top: 90px; margin-bottom: -45px; position: relative;">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="switch-philosophy-part1" onchange="javascript:showContent('philosophy-part1')" value=" <?= $isShow2 == 1 ? '0' : '1' ?>"  <?= $isShow2 == 1 ? 'checked' : '1' ?>>
