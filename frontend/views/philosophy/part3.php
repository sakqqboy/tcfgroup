    ...
    <div class="row">
        ...
        <div class=" col-12 text-end edit-content">
            <a class="btn btn-warning bt-line"
                href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $shot['contentId']]) ?>"
...
<div class="col-12 pr12 mt-50">
    ...
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line"
            href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $gi['contentId']]) ?>"
            target="_blank">Edit</a>
    </div>
    <?php
    }
...
<div class="col-12 pr12 mt-50">
    ...
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line"
            href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $or['contentId']]) ?>"
            target="_blank">Edit</a>
    </div>
    <?php
    }
...
<div class="col-12 pr12 mt-50">
    ...
    <div class=" col-12 text-end edit-content">
        <a class="btn btn-warning bt-line"
            href="<?= Path::backendUrl() . 'content/default/content-detail/' . ModelMaster::encodeParams(["contentId" => $ti['contentId']]) ?>"
            target="_blank">Edit</a>
    </div>
    <?php
    }
