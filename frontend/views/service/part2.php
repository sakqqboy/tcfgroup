            ...
            <div class="row" style="display: <?= $i == 1 ? '' : 'none' ?>;" id="background-<?= $i ?>">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt-20">
                    ...
                    <div class="col-12 text-end mt-30">
                        <button type="button" id="prev" class="btn btn-outline-dark" onclick="javascript:previousContent(<?= $i ?>)"><i class="fa fa-angle-left" aria-hidden="true"></i>
                        </button>
                        <button type="button" id="next" class="btn btn-outline-dark" onclick="javascript:nextContent(<?= $i ?>)"><i class="fa fa-angle-right" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
