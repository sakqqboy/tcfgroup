...
<div class="col-12" id="service-part2"
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="switch-service-part2"
                onchange="javascript:showContent('service-part2')" value=" <?= $isShow2 == 1 ? '0' : '1' ?>"
                <?= $isShow2 == 1 ? 'checked' : '1' ?>>
...
<div class="col-12" id="service-part3"
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="switch-service-part3"
                onchange="javascript:showContent('service-part3')" value=" <?= $isShow2 == 1 ? '0' : '1' ?>"
                <?= $isShow2 == 1 ? 'checked' : '1' ?>>
...
<div class="col-12" id="service-part4"
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="switch-service-part4"
                onchange="javascript:showContent('service-part4')" value=" <?= $isShow2 == 1 ? '0' : '1' ?>"
                <?= $isShow2 == 1 ? 'checked' : '1' ?>>
...
<div class="col-12" id="service-part5"
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="switch-service-part5"
                onchange="javascript:showContent('service-part5')" value=" <?= $isShow2 == 1 ? '0' : '1' ?>"
                <?= $isShow2 == 1 ? 'checked' : '1' ?>>
...
<div class="col-12" id="service-part6"
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="switch-service-part6"
                onchange="javascript:showContent('service-part6')" value=" <?= $isShow2 == 1 ? '0' : '1' ?>"
                <?= $isShow2 == 1 ? 'checked' : '1' ?>>
...
<div class="col-12" id="service-part7"
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" role="switch" id="switch-service-part7"
                onchange="javascript:showContent('service-part7')" value=" <?= $isShow2 == 1 ? '0' : '1' ?>"
                <?= $isShow2 == 1 ? 'checked' : '1' ?>>
