...
<div class="col-12" style="margin-top: 90px; margin-bottom: -85px;">
    <div class="form-check form-switch">
        <input class="form-check-input" type="checkbox" role="switch" id="switch-services-part1"
            onchange="javascript:showContentBranch('services-part1', <?= $branchId ?>)"
            value=" <?= $isShow == 1 ? '0' : '1' ?>" <?= $isShow == 1 ? 'checked' : '1' ?>>
...
<div class="col-12 banner-text-service">
    ...
    <div class="offset-1 col-11">
        <button type="button" class="btn btn-primary button-sv"> <?= $tg['detail2'] ?></button>
    </div>
</div>
<?php
        $i++;
