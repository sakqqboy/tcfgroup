        ...
        <div class="col-lg-6 col-md-6 col-12">
            ...
            <div id="carouselExampleControls" class="carousel slide mt-40" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item text-center">
                        <img src="<?= Yii::$app->homeUrl ?>img/laos.png" class="img-country1">
                    </div>
                    <div class="carousel-item text-center">
                        <img src="<?= Yii::$app->homeUrl ?>img/malaysia.png" class="img-country1">
                    </div>
                    <div class="carousel-item text-center">
                        <img src="<?= Yii::$app->homeUrl ?>img/mongolia.png" class="img-country1">
                    </div>
                </div>
