...
<div class="col-12 pr12 background-gardient" style="margin-top: 90px;">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-12">
            <img src="<?= Path::backendUrl() ?>image/img/sign-up.png" class="width-12">
        </div>
        <div class="col-lg-1">
            <img src="<?= Path::backendUrl() ?>image/img/woman-img.png" class="width-woman">
        </div>
...
<!-- <div class="col-12 pr12" style="margin-top: 90px;">
    <div class="row">
        <div class="col-lg-6 col-md-6 col-12">
            <img src="<?= Path::backendUrl() ?>image/img/sign-up.png" class="width-12">
        </div>
        <div class="content">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-6 mt-20 pl-50">
                        <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"><i class="fa fa-user con-color"
                                    aria-hidden="true"></i></span>
                            <input type="text" class="form-control con-color1" placeholder="Firstname" name="firstName"
                                aria-label="Firstname" aria-describedby="addon-wrapping" required>
                        </div>
                    </div>
                    <div class="col-6 mt-20 lastname-cs">
                        <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"><i class="fa fa-user con-color"
                                    aria-hidden="true"></i></span>
                            <input type="text" class="form-control con-color1" placeholder="Lastname" name="lastName"
                                aria-label="lastname" aria-describedby="addon-wrapping" required>
                        </div>
                    </div>
                </div>
                <div class="col-11 mt-20 pl-40">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text" id="addon-wrapping"><i class="fa fa-user con-color"
                                aria-hidden="true"></i></span>
                        <input type="text" class="form-control con-color1" placeholder="Username" name="username"
                ...
                <div class="col-11 mt-20 pl-40">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text" id="addon-wrapping"><i class="fa fa-user con-color"
                                aria-hidden="true"></i></span>
                        <input type="text" class="form-control con-color1" placeholder="Nickname" name="nickName"
                            aria-label="Nickname" aria-describedby="addon-wrapping" required>
                    </div>
                </div>
                <div class="col-11 mt-20 pl-40">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text" id="birthday"><i class="fa fa-birthday-cake con-color"
                                aria-hidden="true"></i></span>
                        <input type="date" class="form-control con-color1" placeholder="Birthday" name="birthDate"
                            required>
                    </div>
                </div>
                <div class="col-11 mt-20 pl-40">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text" id="email"><i class="fa fa-envelope con-color"
                                aria-hidden="true"></i></span>
                        <input type="email" class="form-control con-color1" placeholder="Email" aria-label="Email"
                            name="email" required>
                    </div>
                </div>
                <div class="col-11 mt-20 pl-40">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text"><i class="fa fa-unlock-alt con-color"
                                aria-hidden="true"></i></span>
                        <input id="password_hash" type="password" class="form-control con-color1" placeholder="password"
                            name="password_hash">
                        <span class="input-group-text" onmousedown="javascript:showPassword2()"
                            onmouseup="javascript:setPassword2()"><i class="fa fa-eye curser-eye"
                                aria-hidden="true"></i></span>
                    </div>
                </div>
                <div class="col-11 mt-20 pl-40">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text"><i class="fa fa-unlock-alt con-color"
                                aria-hidden="true"></i></span>
                        <input id="password3" type="password" class="form-control con-color1"
                            placeholder="Repeat your password" name="password3">
                        <span class="input-group-text" onmousedown="javascript:showPassword3()"
                            onmouseup="javascript:setPassword3()"><i class="fa fa-eye curser-eye"
                                aria-hidden="true"></i></span>
                    </div>
                </div>
                <div class="col-11 mt-20 pl-40">
