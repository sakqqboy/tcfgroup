...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
        <a href="<?= Yii::$app->homeUrl ?>" class="nav-link"><img
                src="<?= Path::backendUrl() ?>image/img/tcg-group-bangladesh.png" class="" style="width: 200px;"></a>
        ...
        <div class="collapse navbar-collapse mt-3" id="navbarScroll">
            <ul class="navbar-nav me-auto  navbar-nav-scroll"
                ...
                <li class="nav-item">
                    <a href="<?= Yii::$app->homeUrl ?>newsletter/index/<?= ModelMaster::encodeParams(['branchName' => $branchName]) ?>"
                ...
                <li class="nav-item">
                    <a href="<?= Yii::$app->homeUrl ?>about-us-country/index/<?= ModelMaster::encodeParams(['branchName' => $branchName]) ?>"
