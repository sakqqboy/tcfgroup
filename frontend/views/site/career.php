...
<div class="">
    ...
    <div class="col-12">
        <img src="<?= Yii::$app->homeUrl ?>image/job-postd.png" class="image-job-postd">
    </div>
...
<div class="col-12  text-future">
    <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png" class="image mr-1"> The Future Awaits at Tokyo Consulting Group
</div>
...
<div class="col-12 title-explore">
    <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png" class="image mr-1"> Explore The Opportunities
</div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-12 title-txt1">
            ...
            <p>As an intern at Tokyo Consulting Firm Limited,
                ...
                valuable hands-on experience in the consulting
                industry. You will be able to apply your skills
                and knowledge to real-world projects, and have
                the chance to make a meaningful impact on the
                success of the company. In addition to gaining
                practical experience, you will also have the
                opportunity to network with industry leaders
                and build your professional network. The
                internship program at Tokyo Consulting
                Firm Limited is an excellent opportunity
...
<div class="col-12  mt-50 col-background">
    <div class="col-12 Global-Business">
        <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png" class="image mr-1"> Our Global Locations
    </div>
    <div class="col-12 text-TCG">
        Discover Jobs In your Country
    </div>
    <div class="col-12">
...
<div class="col-12 mt-50 title-open">
    <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png" class="image mr-1"> Open Vaca ncies
</div>
