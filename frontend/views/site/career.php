...
<div class="">
    ...
    <div class="col-5 text-end vlog-box-two">
        YASUNARI KUNO, CEO
    </div>
</div>
...
<div class="col-12">
    ...
    <div class="col-12 box-data-1">
        <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png"> Reason for Existence, Philosophy
    </div>
    <div class="col-12 box-data-2">
        “Things that must not be changed”
    </div>
    <div class="col-5 box-data-3">
...
<div class="col-12">
    ...
    <div class="col-12 Block-1">
        <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png"> Vision & Strategy
    </div>
    <div class="col-12 Block-2">
        “Things that must not be changed”
    </div>
    <div class="col-5 Block-3">
        Companies must continue to change according to the trends of the times, such as medium- to long-term visions, strategies, and tactics. If you don't ride the "current", your company won't grow big. Because the times are opportunities for growth. However, chasing only the "fashion" will not continue to grow in the long term. Because it goes against the essence of management. Without confusing the two, we must formulate a long-term vision, a medium-term vision, and strategies to materialize them. </div>
</div>

<div class="col-12">
    <div class="col-12">
        <img src="<?= Yii::$app->homeUrl ?>image/whale.png" class="image-whale">
    </div>
    <div class="col-12 Type-home-page-one">
        <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png"> How Far Should the Company Grow?
    </div>
    <div class="col-5 Type-home-page-two">
...
<div class="col-12 pr12">
    <div class="row">
        <div class="col-12 padding-box">
            <img src="<?= Yii::$app->homeUrl ?>image/Rectangle1.png"> Tokyo Consulting Group Strategy
        </div>
    </div>
    <div class="col-12">
        <div class="col-7 padding-text">
