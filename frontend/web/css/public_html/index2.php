		...
		<div class="col-lg-6 col-md-6 col-12 form-Questions" style="margin-top:50px;">
			...
			<div class="row">
				...
				<div class="col-6 text-end mt-4">
					<h4>Email</h4>
					<p>f-info@tokyoconsultinggroup.com <img src="<?= Yii::$app->homeUrl ?>image/letter.png" style="width: 15px;" height="15px"></p>
				</div>
				<div class="col-6 text-start mt-4">
					<h4>Skype</h4>
				...
				<div class="col-6 text-end mt-4">
					<h4>Phone</h4>
					<p> +090-111-222<img src="<?= Yii::$app->homeUrl ?>image/phone-call.png" style="width: 15px" height="15px"></p>
				</div>
			</div>
		</div>
	</div>
